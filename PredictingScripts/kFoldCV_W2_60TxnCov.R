...
P_metadata <- W2SputumSamples60_pipeSummary %>% dplyr::select(SampleID2, Outcome)
...
# This isn't working... Not enough samples probably
# HAD TO STOP HERE!
...
#        file = paste0("10fold3repeatCV_LR_W2_60Cov_Coefficients.pdf"),
...
roc_plot
# ggsave(roc_plot,
#        file = paste0("10fold3repeatCV_LR_W2_60Cov_ROC.pdf"),
#        path = "Figures/PredictiveModeling/kfold_LR",
...
#        file = paste0("10fold3repeatCV_LR_W2_60Cov_Probablities.pdf"),
#        path = "Figures/PredictiveModeling/kfold_LR",
#        width = 6, height = 4, units = "in")
...
roc_Val_plot
# ggsave(roc_Val_plot,
#        file = paste0("10fold3repeatCV_LR_W2_60Cov_ROC_Validation.pdf"),
#        path = "Figures/PredictiveModeling/kfold_LR",
#        width = 6, height = 4, units = "in")
...
#        file = paste0("10fold3repeatCV_LR_W2_60Cov_Probabilities_Validation.pdf"),
#        path = "Figures/PredictiveModeling/kfold_LR",
#        width = 6, height = 4, units = "in")
