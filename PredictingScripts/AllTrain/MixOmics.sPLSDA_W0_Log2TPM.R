...
###****************###
# RESULTS:
# The AUC is 0.9631 for Component 1
###****************###
...
PCA1 <- plotIndiv(pca.1, group = myY, ind.names = F, # plot the samples projected 
...
set.seed(23)
tune.splsda.train <- tune.splsda(myX, myY, ncomp = 7, 
                                 validation = 'Mfold',
                                 folds = my_nfolds, nrepeat = my_nrepeats,
...
plot(tune.splsda.train, col = color.jet(7)) # plot output of variable number tuning
...
# 0.9631
auc.splsda = auroc(final.splsda, roc.comp = 2, print = F)
auc.splsda = auroc(final.splsda, roc.comp = 7, print = F)
# Saved via export
