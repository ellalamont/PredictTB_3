...
# Giving only the enduring hypoxic response genes
# 5/15/26

###****************###
# RESULTS:
# Parameters: 4-FOLD, 30 REPEAT, Elastic Net, TPM, W0, Enduring Hypoxic Response genes
# Alpha = 0.25
# Area under the curve: 0.625
# Genes used: ~90 of the EHR genes
###****************###
...
my_folderPath <- "Figures/PredictiveModeling/AllTrain/EHR_4F30R.lasso_W0_TPM"
my_figureTitle <- "EHR 4F30R LR TPM"

# What genes we are down selecting to
GeneList <- allGeneSetList$EllaGeneSets_2026.05.11$`Enduring hypoxic response Rustad2008`
...
kfold_model_EHR_4F30R.EN_W0_TPM <- run_glmnet_cv(myX, myY, nfolds = my_nfolds, nrepeats = my_nrepeats)
kfold_model <- kfold_model_EHR_4F30R.EN_W0_TPM
