...
###****************###
# RESULTS:
# Parameters: 4-FOLD, 30 REPEAT, Elastic Net, TPM, W0
# Alpha = 0.5
# Area under the curve: 0.8239
# Still doesn't look like relapses are being predicted well
###****************###
...
my_folderPath <- "Figures/PredictiveModeling/AllTrain/4F30R.lasso_W0_TPM"
my_figureTitle <- "4F30R LR TPM"
...
kfold_model_4F30R.EN_W0_TPM <- run_glmnet_cv(myX, myY, nfolds = my_nfolds, nrepeats = my_nrepeats)
kfold_model <- kfold_model_4F30R.EN_W0_TPM
