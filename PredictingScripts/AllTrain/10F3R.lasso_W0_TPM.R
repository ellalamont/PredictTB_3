...
###****************###
# RESULTS:
# Parameters: 10-FOLD, 3 REPEAT, LASSO, TPM, W0
# Alpha = 
...
my_folderPath <- "Figures/PredictiveModeling/AllTrain/10F3R.lasso_W0_TPM"
my_figureTitle <- "10F3R LR TPM"
...
kfold_model_10F3R.lasso_W0_TPM <- run_glmnet_cv(myX, myY, nfolds = my_nfolds, nrepeats = my_nrepeats)
kfold_model <- kfold_model_10F3R.lasso_W0_TPM
