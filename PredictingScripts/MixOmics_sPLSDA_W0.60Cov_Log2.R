...
#        path = "Figures/PredictiveModeling/Mixomics_PLSDA/W0_60Cov_Log2",
...
# write_xlsx(my_list_df, "Figures/PredictiveModeling/Mixomics_PLSDA/W0_60Cov_Log2/Variable_Stability_FinalsPLSDA_W0.60Cov.xlsx")

## Correlation Circle Plot ##
plotVar(final.splsda.train, comp = c(1,2), cex = 3) # generate correlation circle plot

# Another interesting plot
plotLoadings(final.splsda.train, method = 'mean', contrib = 'max')  
...
Probability_Val_plot <- ggplot(validation_plot_df, aes(x = True_Outcome, y = Relapse_probibility)) +
  ...
  labs(x = "True outcome",
       ...
       title = "MixOmics W0 60Cov log2 scaled") +
  theme_bw()
Probability_Val_plot
# ggsave(Probability_Val_plot,
#        file = paste0("TestProbabilities_W0.60Cov_v1.pdf"),
#        path = "Figures/PredictiveModeling/Mixomics_PLSDA/W0_60Cov_Log2",
